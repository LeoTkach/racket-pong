...
async function applySimplifiedStreakFunction() {
  try {
    console.log('🔧 Applying simplified streak calculation function (date + ID only)...\n');
    ...
    // Recalculate streaks
    console.log('🔄 Recalculating streaks with simplified function (date + ID)...');
